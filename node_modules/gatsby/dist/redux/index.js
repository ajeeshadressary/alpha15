...
var saveState = _.debounce(function (state) {
  ...
  var pickedState = _.pick(state, ["nodes", "pages", "pageDataDependencies", "pageComponents"]);
  fs.writeFile(`${process.cwd()}/.cache/redux-state.json`, (0, _stringify2.default)(pickedState, null, 2));
}, 1000);
  ...
  if (node.content) {
    ...
    return new Promise(function (resolve) {
      ...
      var plugin = store.getState().flattenedPlugins.find(function (plug) {
        return plug.name === node.pluginName;
      });
