...
exports.addPageDependency = function (_ref) {
  var path = _ref.path,
      nodeId = _ref.nodeId,
  ...
  if (connection && _.includes(state.pageDataDependencies.connections, connection)) {
    connectionDependencyExists = true;
  }
  ...
  var action = actions.addPageDependency({ path, nodeId, connection });
