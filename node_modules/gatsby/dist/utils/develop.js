                ...
                if (parsedPath.extname === `` || parsedPath.extname === `.html`) {
                  if (htmlStr) {
                    ...
                    try {
                      ...
                      var htmlElement = React.createElement(HTML, {
                        body: ``,
                        headComponents: _.flattenDeep(apiRunner(`modifyHeadComponents`, { headComponents: [] }, [])),
                        postBodyComponents: _.flattenDeep(apiRunner(`modifyPostBodyComponents`, { headComponents: [] }, [])).concat([React.createElement("script", { src: "/commons.js" })])
                      });
