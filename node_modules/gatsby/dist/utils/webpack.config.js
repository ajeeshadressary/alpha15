...
var _require2 = require("./js-chunk-names"),
  layoutComponentChunkName = _require2.layoutComponentChunkName;
...
module.exports = function () {
  var _ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee(program, directory, suppliedStage) {
    ...
    var babelStage, stage, babelConfig, output, entry, plugins, resolve, devtool, module, resolveLoader, config, validatedConfig;
          ...
          case 0:
              ...
              switch (stage) {
                case `develop`:
                  return [new _webpack2.default.optimize.OccurenceOrderPlugin(), new _webpack2.default.HotModuleReplacementPlugin(), new _webpack2.default.NoErrorsPlugin(), new _webpack2.default.DefinePlugin({
                    "process.env": {
                      NODE_ENV: (0, _stringify2.default)(process.env.NODE_ENV ? process.env.NODE_ENV : `development`),
                      PUBLIC_DIR: (0, _stringify2.default)(`${process.cwd()}/public`)
                    },
                    __PREFIX_LINKS__: program.prefixLinks,
                    __LINK_PREFIX__: (0, _stringify2.default)(store.getState().config.linkPrefix)
                  }),
                ...
                case `build-css`:
                  return [new _webpack2.default.DefinePlugin({
                    "process.env": {
                      NODE_ENV: (0, _stringify2.default)(process.env.NODE_ENV ? process.env.NODE_ENV : `production`),
                      PUBLIC_DIR: (0, _stringify2.default)(`${process.cwd()}/public`)
                    },
                    __PREFIX_LINKS__: program.prefixLinks,
                    __LINK_PREFIX__: (0, _stringify2.default)(store.getState().config.linkPrefix)
                ...
                case `build-javascript`:
                  {
                    ...
                    components = components.map(function (component) {
                      return layoutComponentChunkName(program.directory, component);
                    });
                    ...
                    return [
                      ...
                      new _webpack2.default.optimize.CommonsChunkPlugin({
                        ...
                        minChunks: function minChunks(module, count) {
                          var vendorModuleList = [`react`, `react-dom`, `react-router`, `react-router-scroll`, `scroll-behavior`, `history`];
            ...
            entry = function entry() {
              switch (stage) {
                case `develop`:
                  return {
                    commons: [require.resolve(`react-hot-loader/patch`), `${require.resolve(`webpack-hot-middleware/client`)}?path=http://${program.host}:${webpackPort}/__webpack_hmr`, `${directory}/.cache/app`]
                  };
                case `build-css`:
                  return {
            ...
            stage = suppliedStage === `develop-html` ? `develop` : suppliedStage;
            _context.next = 11;
